...
```ruby
Uggle.force_binary_collation = true
```

Or by running this rake task:

```shell
rake uggle_engine:tag_names:collate_bin
```
...
class User < ActiveRecord::Base
  acts_as_taggable # Alias for uggle :tags
  uggle :skills, :interests
end
...
@user.reload
@user.tags
=> [#<Uggle::Tag id: 1, name: "awesome", taggings_count: 1>,
 #<Uggle::Tag id: 2, name: "slick", taggings_count: 1>,
 #<Uggle::Tag id: 3, name: "hefty", taggings_count: 1>]
```
...
@user.reload
@user.skills
=> [#<Uggle::Tag id: 1, name: "joking", taggings_count: 1>,
 #<Uggle::Tag id: 2, name: "clowning", taggings_count: 1>,
 #<Uggle::Tag id: 3, name: "boxing", taggings_count: 1>]
...
User.skill_counts
=> [#<Uggle::Tag id: 1, name: "joking", taggings_count: 1>,
 #<Uggle::Tag id: 2, name: "clowning", taggings_count: 2>,
 #<Uggle::Tag id: 3, name: "boxing", taggings_count: 1>]
```
...
```ruby
class MyParser < Uggle::GenericParser
  def parse
    Uggle::TagList.new.tap do |tag_list|
...
@some_photo.owner_tags_on(@some_user, :locations) # => [#<Uggle::Tag id: 1, name: "paris">...]
...
Because we specified `uggle` on the `User` class, we can
...
```ruby
Uggle.force_lowercase = true
```

If you want tags to be saved parametrized (you can redefine to_param as well):

```ruby
Uggle.force_parameterize = true
```
...
```ruby
Uggle.tags_table = 'aato_tags'
Uggle.taggings_table = 'aato_taggings'
```

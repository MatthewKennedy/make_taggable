module Uggle
  class Tagging < ::ActiveRecord::Base #:nodoc:
    self.table_name = Uggle.taggings_table

    DEFAULT_CONTEXT = 'tags'
    belongs_to :tag, class_name: '::Uggle::Tag', counter_cache: Uggle.tags_counter
    ...
    def remove_unused_tags
      if Uggle.remove_unused_tags
        if Uggle.tags_counter

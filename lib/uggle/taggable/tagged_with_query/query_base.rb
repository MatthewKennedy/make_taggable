module Uggle::Taggable::TaggedWithQuery
  class QueryBase
    ...
    def tag_match_type(tag)
      ...
      matches_attribute = matches_attribute.lower unless Uggle.strict_case_match
    ...
    def escaped_tag(tag)
      tag = tag.downcase unless Uggle.strict_case_match
      Uggle::Utils.escape_like(tag)
    end

module Uggle
  module Taggable
    ...
    ##
    # This is an alias for calling <tt>uggle :tags</tt>.
    #
    # Example:
    ...
    private
      ...
      # so that the original uggle method is unaffected
    ...
    def taggable_on(preserve_tag_order, *tag_types)
      ...
      if taggable?
        ...
        class_eval do
          has_many :taggings, as: :taggable, dependent: :destroy, class_name: '::Uggle::Tagging'
          has_many :base_tags, through: :taggings, source: :tag, class_name: '::Uggle::Tag'
